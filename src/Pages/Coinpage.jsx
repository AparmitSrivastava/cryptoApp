  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.sidebar}>
        <img src={coin?.image.large} alt={coin?.name} width={200} style={{marginBottom:20}} />
        <Typography variant="h3" className={classes.heading}>
          {coin?.name}
        </Typography>

         {/* now we have to npm install react-html-parser --legacy-peer-deps - because the some coins have a very wierd descripton that has symbols and links in it that we dont want  */}
...
// we want to access each coin separately